...
export default function LightingElectricalPage() {
  const products = [
    { name: "Dual-Row 40-Inch LED Light Bar", specs: "20,000 Lumens, Combo Beam, Aluminum Heat Sink", price: "$280.00" },
    { name: "Laser Hybrid Driving Pod Lights", specs: "High-intensity spot beam, Pack of 2 with wiring harness", price: "$195.00" },
    { name: "Smart Dual Battery Isolator Kit", specs: "140Amp voltage-sensitive relay with smart sensing technology", price: "$110.00" },
    { name: "8-Gang Multi-Switch Panel Control System", specs: "Programmable layout, solid-state circuit, blue backlight", price: "$145.00" },
  ];
