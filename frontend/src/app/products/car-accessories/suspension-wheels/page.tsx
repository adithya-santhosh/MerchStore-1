...
export default function SuspensionWheelsPage() {
  const products = [
    { name: "Premium 2.5-Inch Stage 2 Lift Kit", specs: "High-travel coil springs, heavy-duty control arms, alignment shims", price: "$1,150.00" },
    { name: "Heavy-Duty Reservoir Bypass Shock Absorbers", specs: "Adjustable dampening dials, nitrogen-charged, set of 4", price: "$890.00" },
    { name: "All-Terrain Radical Grabber Tyres", specs: "Deep tread pattern, reinforced multi-ply sidewall, 33-inch", price: "$220.00" },
    { name: "Flow-Formed Matte Black Alloy Wheels", specs: "Lightweight high-strength aluminum, offset beadlock style, 17-inch", price: "$185.00" },
  ];
      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
        ...
        <div className="max-w-3xl mb-12 sm:mb-16 space-y-4">
          ...
          <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            Ultimate off-road clearance and heavy-duty chassis upgrades. Suspension geometry lift kits, premium reservoir bypass nitrogen-charged shock absorbers, deep all-terrain radial tyres, and heavy alloy wheels.
          </p>
        </div>
