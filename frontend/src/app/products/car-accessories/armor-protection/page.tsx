...
export default function ArmorProtectionPage() {
  const products = [
    { name: "Heavy-Duty Steel Bull Bar Bumper", specs: "Textured black powder coat, winch-ready, LED pod mounts", price: "$680.00" },
    { name: "Chassis-Mounted Steel Rock Sliders", specs: "Reinforced support plates, protective kick-out styling", price: "$320.00" },
    { name: "4mm Premium Aluminum Bash Plate Set", specs: "Protects oil pan, transfer case, and transmission, custom fitted", price: "$240.00" },
    { name: "High-Clearance Rear Bumper & Tyre Carrier", specs: "Integrated shackle points, modular dual swing arm capability", price: "$750.00" },
  ];
      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
        ...
        <div className="max-w-3xl mb-12 sm:mb-16 space-y-4">
          ...
          <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            Engineered armor panels protecting critical mechanical drivetrains. Heavy steel front bull bumpers, protective structural side rock sliders, protective engine bash skid plates, and dual tire-carrier rear bumpers.
          </p>
        </div>
